      ...
      <footer className="footer-distributed">
        ...
        <div className="footer-right">
          <p className="footer-company-about">
            ...
            At Boundles, our heart and soul is to provide you with the finest of
            experiences, where we will cater to your every whim and every need.
            Ask us for the stars.
          </p>
